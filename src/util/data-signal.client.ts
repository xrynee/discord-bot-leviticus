import { SignalHistory } from '../interface';

import { Environment, EnvKey } from './environment';

export class DataSignalClient {
    ...
    constructor() {
        ...
        this.baseUrl = Environment.get(EnvKey.SIGNAL_BASE_URL);
    ...
    async getLatest(dt: string, signalId: string) {
        return this.get<SignalHistory>(`/signal/${signalId}?date=${dt}&latest=true`);
    }
